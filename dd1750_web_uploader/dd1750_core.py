...
def generate_dd1750_from_pdf(bom_pdf, template_pdf, cfg, out_pdf, out_audit_csv,
                            force_ocr=False, ocr_dpi=250, page_start=0, label="NSN"):
...
def generate_dd1750_from_excel(excel_path, template_pdf, cfg, out_pdf, out_audit_csv,
                               sheet=None, col_desc="Description", col_mat="Material", col_qty="OH QTY", label="NSN"):
